...
This file is the quick-reference operating contract for unicode-width-kotlin. The longer
...
unicode-width-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`unicode-width`](https://crates.io/crates/unicode-width). Upstream Rust is the behavioral oracle while the
